...
# Based on:
# https://github.com/docker-library/postgres/blob/master/10/bullseye/docker-entrypoint.sh
set -Eeo pipefail
...
# check to see if this file is being runor sourced from another script
_is_sourced() {
